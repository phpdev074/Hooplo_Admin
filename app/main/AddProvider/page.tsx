...
import {
  ...
  Upload, CheckCircle, Clock, Calendar, Users, FileText
} from 'lucide-react';
...
const SERVICE_CATEGORIES = [
  ...
  { id: 'injection-nurses', label: 'Injection Nurses / Home Nurses', icon: '💉' },
  { id: 'fertility-clinics', label: 'Fertility Clinics (IVF)', icon: '🏥' },
  { id: 'ivf-clinics', label: 'IVF Clinics', icon: '🧬' },
  { id: 'diagnostic-centers', label: 'Diagnostic & Imaging Centers', icon: '⚕️' },
...
export default function AddProviderScreen({ onBack, provider }: AddProviderScreenProps) {
  ...
  const toggleService = (serviceId: string) => {
    ...
    if (!formData.selectedServices.includes(serviceId)) {
      handleInputChange('selectedServices', [...formData.selectedServices, serviceId]);
    }
  };
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                    <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-xl p-4 border border-pink-200">
                      <label className="flex items-center justify-between cursor-pointer">
                        <div>
                          <p className="font-bold text-gray-900">Treatment Support</p>
                          <p className="text-xs text-gray-600 mt-1">Provide IVF/IUI treatment</p>
                        </div>
                        <div className="relative">
                          <input
                            type="checkbox"
                    ...
                    <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-xl p-4 border border-pink-200">
                      <label className="flex items-center justify-between cursor-pointer">
                        <div>
                          <p className="font-bold text-gray-900">Urgency Support</p>
                          <p className="text-xs text-gray-600 mt-1">Urgent delivery available</p>
                        </div>
                        <div className="relative">
                          <input
                            type="checkbox"
                            ...
                            {[
                              ...
                              return (
                                <button
                                  ...
                                  className={`px-8 py-3 rounded-full font-bold text-sm transition-all border-2 ${isSelected
                                    ? 'bg-white text-pink-600 border-pink-500 shadow-md'
                                    : 'bg-white text-pink-400 border-transparent hover:border-pink-300'
                                    }`}
                                >
              ...
              >
                ...
                <div className="p-6 space-y-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    ...
                    <div>
                      <label className="block text-sm font-bold text-gray-700 mb-2">
                        Map Pin Location <span className="text-pink-600">*</span>
                      </label>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      <label className="block text-sm font-bold text-gray-700 mb-2">
                        Languages Supported <span className="text-pink-600">*</span>
                      </label>
                      <input
                        type="text"
                        required
              ...
              >
                ...
                <div className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {DAYS.map((day) => (
                      <div key={day} className="border border-gray-200 rounded-xl p-4 hover:border-pink-300 transition-colors">
              ...
              >
                ...
                <div className="flex flex-col items-center gap-4">
                  ...
                  <p className="text-xs text-center text-gray-500">
                    PNG, JPG or SVG<br />Recommended 500x500px
                  </p>
                </div>

                <div className="mt-6 pt-6 border-t border-gray-200">
                  <h4 className="text-sm font-bold text-gray-900 mb-3">Verification Status</h4>
                  <label className="flex items-start gap-3 cursor-pointer group">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-bold text-gray-900">Verified Provider</span>
                      </div>
              ...
              >
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`font-bold ${formData.name && formData.email && formData.phone ? 'text-green-600' : 'text-gray-400'}`}>
                      {formData.name && formData.email && formData.phone ? '✓' : '○'}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700">Service Type</span>
                    <span className={`font-bold ${formData.serviceType ? 'text-green-600' : 'text-gray-400'}`}>
                      {formData.serviceType ? '✓' : '○'}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700">Services</span>
                    <span className={`font-bold ${formData.selectedServices.length > 0 ? 'text-green-600' : 'text-gray-400'}`}>
                      {formData.selectedServices.length > 0 ? '✓' : '○'}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700">Location</span>
                    <span className={`font-bold ${formData.address && formData.city ? 'text-green-600' : 'text-gray-400'}`}>
